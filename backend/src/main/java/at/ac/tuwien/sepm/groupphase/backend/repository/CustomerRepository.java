...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query(value = "INSERT INTO customer(id,name,login_name,password,email,address_id,phone_number) VALUES :id,:name,:login_name,:password,:email,:address_id,:phone_number", nativeQuery = true)
